...
var initializeScroll = function initializeScroll() {
     ...
     */
    window.addEventListener('scroll', (0, lodash_throttle_1.default)(function () {
...
var init = function init(settings) {
     ...
     */
    window.addEventListener('resize', (0, lodash_debounce_1.default)(refresh, options.debounceDelay, true));
    window.addEventListener('orientationchange', (0, lodash_debounce_1.default)(refresh, options.debounceDelay, true));
    return $aosElements;
};
/**
 * Export Public API
