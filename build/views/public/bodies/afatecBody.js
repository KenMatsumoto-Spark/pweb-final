"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _afatec = require('../../../data/afatec');

let imagesSection = ""
_afatec.afatec.images.forEach((img) => {
...
<section>
  <div class="row text-video">
    ...
    <div class="afatec-text col-md-12">
      <h3>
        ${_afatec.afatec.text2}
      </h3>
    </div>
    <div class="afatec-text col-md-12">
      <h3>
        ${_afatec.afatec.text3}
      </h3>
    </div>
    ${imagesSection}
    <div class="afatec-text col-md-12">
      <h3>
        ${_afatec.afatec.text4}
      </h3>
    </div>
    <div class="afatec-text col-md-12">
      <h3>
        ${_afatec.afatec.text5}
      </h3>
    </div>
    <div class="afatec-text col-md-12">
      <h3>
        ${_afatec.afatec.text6}
      </h3>
    </div>
  </div>
</section>

`; exports.afatecBody = afatecBody